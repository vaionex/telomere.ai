...
<div class="flex max-w-7xl mx-auto px-4 sm:px-6 gap-6">
  ...
  <aside class="hidden lg:flex flex-col w-56 flex-shrink-0 sticky top-4 self-start max-h-[calc(100vh-2rem)] overflow-y-auto py-4">
    ...
    <!-- Risk summary -->
    <div class="mb-4 pb-4 border-b border-black/5">
      <p class="text-[10px] font-semibold uppercase tracking-wider text-[var(--color-text-tertiary)] mb-2">Risk Summary</p>
      <div class="grid grid-cols-3 gap-1.5">
        <div class="text-center px-1 py-2 rounded-md bg-red-50">
          <p class="text-sm font-bold text-red-700">{highCount}</p>
          <p class="text-[9px] text-red-600">High</p>
        </div>
        <div class="text-center px-1 py-2 rounded-md bg-amber-50">
          <p class="text-sm font-bold text-amber-700">{modCount}</p>
          <p class="text-[9px] text-amber-600">Moderate</p>
        </div>
        <div class="text-center px-1 py-2 rounded-md bg-blue-50">
          <p class="text-sm font-bold text-blue-700">{carrierCount}</p>
          <p class="text-[9px] text-blue-600">Carrier</p>
        </div>
      </div>
    </div>
